...
<html>
<head>
    <title>Friend & Knead - Data User</title>
    <!-- Meta Library -->
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- Content -->
    <div class="container">
      <h4 class="my-4 text-orange"><i class="fas fa-user pr-2"></i> Data User</h4>
      <hr>
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        function fetch_data() {
          $.ajax({
            url: '../../include/admin/data_user/fetch_data',
            type: 'POST',
        ...
        $(document).on('click', '.btnStatus', function(){  
          ...
          swal({
            ...
            text: 'Ingin mengubah status aktif user',
            type: 'warning',
            ...
            if (result.value) {
              $.ajax({
                url: '../../include/admin/data_user/status',
                type: 'POST',
        ...
        $(document).on('click', '.btnHapus', function(){  
          ...
          swal({
            ...
            if (result.value) {
              $.ajax({
                url: '../../include/admin/data_user/delete',
                type: 'POST',
                data: {id:id},
                success: function () {
                  fetch_data();
